...
const features = [
  ...
  },
  {
    name: "Modern Stack",
    description:
      "Next.js 14 App Router with React Server @/components/commerce, Server Actions, and Edge Runtime for optimal performance.",
    icon: BoltIcon,
  },
  {
    name: "Beautiful UI",
    description:
      "Polished UI with Tailwind CSS, Shadcn UI @/components/commerce, dark/light mode, and responsive design out of the box.",
    icon: SunIcon,
  },
  {
