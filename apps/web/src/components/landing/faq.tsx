    ...
    answer: (
      <>
        ...
        <ul className="list-disc pl-6 mt-2 space-y-1">
          ...
          <li>Modern UI @/components/commerce from Shadcn UI and Tailwind CSS</li>
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <ul className="list-disc pl-6 mt-2 space-y-1">
          <li>Next.js 14 with App Router and React Server @/components/commerce</li>
    ...
    answer: (
      <>
        ...
        <ul className="list-disc pl-6 mt-2 space-y-1">
          ...
          <li>Modify the footer in <code>src/@/components/commerce/footer.tsx</code></li>
